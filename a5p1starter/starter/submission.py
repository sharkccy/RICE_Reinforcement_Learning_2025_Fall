...
class REINFORCEAgent(BaseAgent):
    ...
    def __init__(self, env_make: Callable[[], Any], cfg: TrainConfig):
        ...
        self.entropy_coef_with_baseline = 0.15
    ...
    def update(self, episodes: List[List[Dict]]):
        ...
        print(f"[REINFORCEAgent Policy Gradient]{- (logp_a * advantages).mean().item():.4f}")
        print(f"[REINFORCEAgent] Entropy: {self.entropy_coef_with_baseline * entropy.item():.4f}")
